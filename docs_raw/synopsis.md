...
#### A unified module definition script and build platform to support AMD modules while working seamlessly with the RequireJs optimizer and native global object.
