...
!function(fac, def, reqjs) {
    ...
    umd.factory = umd._factory && function(id, dependancy, callback, error_callback) {
        if (id && id.constructor === Array && this.module) {
            var i = id;
            dependency, error_callback = error_callback, callback = callback, dependency = i, 
    ...
    umd.module && umd.module.require || requirejs, define("second_module", [], function() {
        ...
        console.log(id + " has initialized.");
        var mod = {};
        return mod.id = id, mod[dependency.id] = dependency, mod;
    });
