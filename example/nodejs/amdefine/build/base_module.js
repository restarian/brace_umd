/* Generated by Brace_UMD 0.5.2 */
!function(e, i, o, r) {
    var n, t, s, d, u, f = {
        e: "object" == typeof module,
        i: !1,
        factory: function(i, o, r, t) {
            if (i && i.constructor === Array && this.o) {
                var s = i, d = dependency;
                t = t, r = r, dependency = s, i = n || "";
            }
            ...
            }, this) && (e[i] = r.apply(r.prototype, o.map(function(e, i) {
                return this[e];
            }, e)));
        },
        requirejs: o,
    ...
    n = this.e && module.filename || void 0, t = this.e && module.require("path").dirname(n) || void 0, 
    f.n();
